  ...
  return (
    <>
      <section className="md:bg-[#ddeffd]">
        <Container>
          <h1 className="font-bold text-blue-800 text-3xl border md:text-7xl opacity-10 w-4/6 text-center  md:mx-auto md:pt-24">
            Our Services
          </h1>
          <h6 className="font-sans font-regular text-xl p-8 text-center md:px-16 md:py-8 text-gray-700 w-[400px] md:w-full md:text-2xl">
            We provide comprehensive healthcare solutions, including
            telemedicine consultations, remote patient monitoring, home visits,
            and diagnostic services. Our goal is to make quality care
            accessible, personalized, and convenient, empowering patients to
            manage their health comfortably and securely from home.
          </h6>
